...
- Tasks `done-task-001.md`, `done-task-002.md`, `done-task-003.md`, `done-task-004.md`, `done-task-005.md`, `done-task-008.md`, `done-task-009.md`, `done-task-010.md`, `archived-task-011.md`, `archived-task-012.md`, `done-task-013.md`, `done-task-014.md`, `done-task-016.md`, `done-task-017.md` — apports incrémentaux à l'EPIC (cf. Annexe C).

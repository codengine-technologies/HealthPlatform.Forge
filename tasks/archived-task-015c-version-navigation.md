...
- 2026-05-08
- **dtos-mss** : squash-merged via PR #20 → `e514ef3`
- **api-mail** : squash-merged via PR #53 → `ee2cd79`
- **client-blazor** : squash-merged via PR #48 → `80e511e`
- **client-angular** : code-only — humain gère merge TFS indépendamment

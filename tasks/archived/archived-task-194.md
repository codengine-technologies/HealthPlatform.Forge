...
- CI `develop` api-mail : run https://github.com/codengine-technologies/HealthPlatform.Api.Mail/actions/runs/34237419509 — **verte** (`build` success, `publish` success ; terminée ~4 min après le merge, au-delà de la fenêtre de 2 minutes de la règle 5, sans échec).

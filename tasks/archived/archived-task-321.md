...
- **api-mail** : PR #245 squash-mergée → `6a82f28f7b1031be14928d492bc836c34d77f277` sur `develop` ; branche `feat/task-321-scenario-terrain` supprimée (distante et locale)
- **Contenu additionnel** : commit `1298cb9f` (instrumentation Postgres du banc — `pg_stat_statements`, photos serveur, section rapport), ajouté avec accord humain avant le merge
- **CI develop** : ✅ verte — https://github.com/codengine-technologies/HealthPlatform.Api.Mail/actions/runs/35454799798 (terminée après la fenêtre de 2 min de la règle 5 : run de ~7 min, pas d'échec)

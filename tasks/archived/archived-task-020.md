...
Squash-merged on `develop` (2026-05-02) — HAG validation `--i-tested` from human.

| Repo | PR | Squash SHA |
|---|---|---|
| `dtos-mss` | [#15](https://github.com/codengine-technologies/HealthPlatform.Dtos.Mss/pull/15) | `db91caf802fdb554744b4867dd8c401b1ff0c019` |
| `api-mail` | [#37](https://github.com/codengine-technologies/HealthPlatform.Api.Mail/pull/37) | `f3a0e36edcbd169208d40365759fe757e97868f0` |
| `client-blazor` | [#42](https://github.com/codengine-technologies/HealthPlatform.Client/pull/42) | `3df352842a527aa25f8300524b3e32fd57091bd9` |
| `client-angular` | code-only — humain gère commit/push/PR TFS silencieusement (cf. mémoire forge) | — |

CI develop post-merge : `dtos-mss` ✅ success, `client-blazor` ✅ success, `api-mail` (pas de workflow CI configuré sur ce repo — to investigate hors scope task-020).
